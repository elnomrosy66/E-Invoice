...
public class frmCategories : Master
{
	...
	{
		if (Mess.AskDelete() == DialogResult.Yes && category != null)
		{
	...
	{
		Category category = (Category)MasterCompo.ComboBox.SelectedItem;
		if (category != null)
		{
			this.category = _unitOfWork.Categories.GetTById(category.Id);
			GetData();
		}
	}
	...
	private void InitializeComponent()
	{
		...
		base.ClientSize = new System.Drawing.Size(914, 384);
